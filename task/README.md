...
DM‑Verity support and packaging it as an OCI artifact, as part of our Konflux CI.
...
When the task is executed, a VM is provided that we can use to run our build
steps. For that purpose, we can use SSH to copy files and execute commands on
the VM.
