#virt-install --virt-type kvm --os-variant rhel10.0 --arch x86_64 --boot uefi --name rhel10.0 --memory 8192 --location rhel-10.0-x86_64-dvd.iso --disk path=./disk.qcow2,format=qcow2,bus=scsi,size=7 --initrd-inject=rhel10-dm-root.ks --nographics --extra-args "console=ttyS0 inst.ks=file:/rhel10-dm-root.ks" --transient
